...
/// BakeEyebrows8 — even lighter/thinner per qwen3-vl:8b audit:
///   - colour:    (0.50, 0.38, 0.26)  was (0.42, 0.32, 0.22)
///   - strength:  0.09                 was 0.16
///   - thickness: 3px                  was 4px
///   - passes:    1                    was 1
public static class BakeEyebrows8
{
    [MenuItem("Aivatar/Bake Eyebrows 8 (feather-light)")]
    public static string Run()
    {
        ...
        Color browColor = new Color(0.50f, 0.38f, 0.26f);

        PaintBrowArc(tex, 698, 1455, 658, 1310, 1510, 3f, browColor, 0.09f);
        PaintBrowArc(tex, 1362, 1455, 1402, 1310, 1510, 3f, browColor, 0.09f);

        // Minimal hair strokes
        var rng = new System.Random(42);
        Color hairColor = new Color(0.45f, 0.34f, 0.24f);
        for (int i = 0; i < 8; i++)
        {
            ...
            PaintStroke(tex, (int)rx, (int)ry, 2 + rng.Next(2), (float)(rng.NextDouble() * 0.3 + 0.1), hairColor, 0.08f);
            float lx = Mathf.Lerp(1362, 1402, t) + (float)(rng.NextDouble() - 0.5) * 6;
            PaintStroke(tex, (int)lx, (int)ry, 2 + rng.Next(2), (float)(rng.NextDouble() * 0.3 + 0.1), hairColor, 0.08f);
        }
        ...
        return "BakeEyebrows8: feather-light arcs painted";
    }
