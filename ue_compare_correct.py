"""Compare visemes with CORRECT scrubbing (display-rate frames, not ticks)."""
...
# Use DISPLAY FRAME numbers (not ticks!)
...
for i, (frame, name) in enumerate(frames):
    # CORRECT: pass frame number directly, NOT frame*800
...
grid.save("c:/Users/yuval/src/aivatar/ue_visemes_correct.png", optimize=True)
