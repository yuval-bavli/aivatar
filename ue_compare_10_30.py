"""Compare frame 10 (PP, known working) vs frame 30 (TH, supposedly broken)."""
...
frames = [(0, "F0: sil"), (10, "F10: PP"), (30, "F30: TH")]
...
for i, (frame, name) in enumerate(frames):
    ...
    draw.text((5, 3), name, fill=(255, 255, 100))
    cell.paste(img, (0, 20))
    grid.paste(cell, (i * cell_w, 0))

grid.save("c:/Users/yuval/src/aivatar/ue_compare_frames.png", optimize=True)
